 ...
 * カード決済履歴詳細
 *
 * @ORM\Table(name="plg_remise_payment4_order_result_card")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\Repository\OrderResultCardRepository")
 */
class OrderResultCard
{
    /**
     * @var int
     *
     ...
     *
     */
    private $RemiseACMember;

    /**
     * @var RemiseACResult
     *
     */
    private $RemiseACResult;
     ...
     * Set OrderResult.
     *
     * @param \Plugin\RemisePayment42\Entity\OrderResult|null $OrderResult
     *
     * @return OrderResult
     */
    public function setOrderResult(\Plugin\RemisePayment42\Entity\OrderResult $OrderResult = null)
    {
     ...
     * Get OrderResult.
     *
     * @return \Plugin\RemisePayment42\Entity\OrderResult|null
     */
     ...
     * RemiseACMember の設定
     *
     * @param  \Plugin\RemisePayment42\Entity\RemiseACMember|null $RemiseACMember
     * @return RemiseACMember
     */
    public function setRemiseACMember(\Plugin\RemisePayment42\Entity\RemiseACMember $RemiseACMember = null)
    {
        $this->RemiseACMember = $RemiseACMember;
        return $this;
    }
     ...
     * RemiseACMember の取得
     *
     * @return \Plugin\RemisePayment42\Entity\RemiseACMember|null
     */
    public function getRemiseACMember()
    {
        return $this->RemiseACMember;
    }

    /**
     * RemiseACResult の設定
     *
     * @param  \Plugin\RemisePayment42\Entity\RemiseACResult|null $RemiseACResult
     * @return RemiseACResult
     */
    public function setRemiseACResult(\Plugin\RemisePayment42\Entity\RemiseACResult $RemiseACResult = null)
    {
        $this->RemiseACResult = $RemiseACResult;
        return $this;
    }
     ...
     * RemiseACResult の取得
     *
     * @return \Plugin\RemisePayment42\Entity\RemiseACResult|null
     */
    public function getRemiseACResult()
    {
        return $this->RemiseACResult;
    }
}
