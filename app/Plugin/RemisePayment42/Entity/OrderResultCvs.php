 ...
 * マルチ決済履歴詳細
 *
 * @ORM\Table(name="plg_remise_payment4_order_result_cvs")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\Repository\OrderResultCvsRepository")
 */
class OrderResultCvs
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="pay_no1", type="string", length=30, nullable=true)
     */
    private $pay_no1;
     ...
     * @var string
     *
     * @ORM\Column(name="pay_no2", type="string", length=1000, nullable=true)
     */
    private $pay_no2;
     ...
     * @return \DateTime
     */
    public function getPayDateStr($format)
    {
        if (!$this->pay_date) return "";
        if ($this->pay_date instanceof \DateTime) {
            $workDate = $this->pay_date;
