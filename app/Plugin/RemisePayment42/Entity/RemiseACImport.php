 ...
 * ルミーズ定期購買取込情報
 *
 * @ORM\Table(name="plg_remise_payment4_remise_ac_import")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\Repository\RemiseACImportRepository")
 */
class RemiseACImport
{
    /**
     * @var int
     *
