 ...
 * ルミーズ定期購買バッチ取込管理情報
 *
 * @ORM\Table(name="backup_plg_remise_payment4_remise_ac_import_stack")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\RepositoryBackup\BackupRemiseACImportStackRepository")
 */
class BackupRemiseACImportStack
{
    /**
     * @var integer
     *
     ...
     *
     * @return BackupRemiseACImportStack
     */
