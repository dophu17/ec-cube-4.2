 ...
 * ルミーズ定期購買結果情報
 *
 * @ORM\Table(name="backup_plg_remise_payment4_remise_ac_result")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\RepositoryBackup\BackupRemiseACResultRepository")
 */
class BackupRemiseACResult
{
    /**
     * @var int
     *
