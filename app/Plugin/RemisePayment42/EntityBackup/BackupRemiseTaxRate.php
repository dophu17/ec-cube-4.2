 ...
 * ルミーズ消費税率設定情報
 *
 * @ORM\Table(name="backup_plg_remise_payment4_remise_tax_rate")
 * @ORM\Entity(repositoryClass="Plugin\RemisePayment42\RepositoryBackup\BackupRemiseTaxRateRepository")
 */
class BackupRemiseTaxRate
{
    /**
     * @var int
     *
